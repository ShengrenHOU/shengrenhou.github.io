...
excerpt: "Founder website of Hou Shengren, focused on energy technology, electricity markets, energy AI, and research-to-product translation."
description: "Founder website of Hou Shengren, focused on energy technology, electricity markets, energy AI, and research-to-product translation."
permalink: /
redirect_from:
  - /about/
  - /about.html
...
<div class="lang-block founder-flow" data-lang="en">
  ...
  <section class="founder-section founder-panel" id="current-focus">
    <div class="section-heading">
      ...
      <p>The emphasis is on market-facing systems that move from insight to execution.</p>
    </div>
    <div class="founder-card-grid">
      <article class="founder-card">
        <h3>Market Intelligence</h3>
        <p>Translating fragmented power-market signals into analysis layers that support faster and better decisions.</p>
      </article>
      <article class="founder-card">
  ...
  <section class="founder-section founder-panel" id="research-foundations">
    <div class="section-heading">
      ...
      <p>Research still anchors how I think about products, systems, and energy markets.</p>
    </div>
    <div class="founder-card-grid">
      <article class="founder-card">
      ...
      <article class="founder-card">
        ...
        <p>Turning strong methods into products, workflows, and decision systems that create usable value.</p>
      </article>
    </div>
  </section>
  ...
  <section class="founder-section founder-panel" id="selected-publications">
    <div class="section-heading">
      ...
      <p>Academic publications remain a strong analytical signal, while serving a broader founder and operator story.</p>
    </div>
  ...
  <section class="founder-section founder-panel" id="recent-news">
    <div class="section-heading">
      ...
      <p>A short timeline of public developments across entrepreneurship, research, and market work.</p>
    </div>
    <ul class="selected-publications__list">
      <li class="selected-publications__item">
        <strong>2026</strong>
  ...
  <section class="founder-section founder-panel contact-cta" id="contact-cta">
    <div>
      ...
      <h2>Open to collaboration, speaking, and founder-level conversations in energy.</h2>
...
<div class="lang-block founder-flow" data-lang="zh">
  ...
  <section class="founder-section founder-panel" id="current-focus">
    <div class="section-heading">
      ...
      <h2>我现在真正投入的方向</h2>
      <p>重点不是抽象概念，而是从洞察走向执行的市场化系统。</p>
    </div>
    <div class="founder-card-grid">
      <article class="founder-card">
        <h3>市场情报</h3>
        <p>把分散的电力市场信号转化为可服务于更快、更好决策的分析层与判断框架。</p>
      </article>
      <article class="founder-card">
        <h3>决策支持</h3>
      ...
      <article class="founder-card">
        <h3>能源数字化</h3>
        <p>把模型、产品思维与实际运营连接起来，推进公开面向市场的能源科技实践。</p>
      </article>
    </div>
  </section>
  ...
  <section class="founder-section founder-panel" id="research-foundations">
    <div class="section-heading">
      ...
      <h2>支撑这些工作的分析底座</h2>
      <p>研究训练仍然决定着我理解产品、系统与能源市场的方式。</p>
    </div>
    <div class="founder-card-grid">
      <article class="founder-card">
        <h3>电力市场</h3>
        <p>关注市场设计、价格形成、跨区机制以及短期市场行为。</p>
      </article>
      <article class="founder-card">
        <h3>能源 AI</h3>
      ...
      <article class="founder-card">
        <h3>储能与灵活性</h3>
        <p>聚焦储能调度、灵活性策略与受运行约束影响的市场参与逻辑。</p>
      </article>
      <article class="founder-card">
        <h3>研究转化</h3>
        <p>把扎实的方法做成真正能产生价值的产品、工作流与决策系统。</p>
      </article>
    </div>
  </section>
  ...
  <section class="founder-section founder-panel" id="selected-publications">
    <div class="section-heading">
      <p class="section-kicker">代表论文</p>
      <h2>代表性的学术工作</h2>
      <p>学术发表仍然是重要的分析能力信号，但它服务于更广义的创业与实践叙事。</p>
    </div>
    <ul class="selected-publications__list">
      <li class="selected-publications__item">
        <strong>RL-ADN: A high-performance Deep Reinforcement Learning environment for optimal Energy Storage Systems dispatch in active distribution networks</strong>
  ...
  <section class="founder-section founder-panel" id="recent-news">
    <div class="section-heading">
      ...
      <h2>公开里程碑</h2>
      <p>这里简要记录创业、研究与市场实践中的公开进展。</p>
    </div>
    <ul class="selected-publications__list">
      <li class="selected-publications__item">
        <strong>2026</strong>
        <span>持续推进以 AI 决策系统和市场数字化为重点的公开面向市场能源科技工作。</span>
      </li>
      <li class="selected-publications__item">
        <strong>2025</strong>
  ...
  <section class="founder-section founder-panel contact-cta" id="contact-cta">
    <div>
      ...
      <h2>欢迎围绕合作、演讲与 founder 级能源议题交流。</h2>
      <p>如果你的工作涉及电力市场、储能策略、能源 AI 或研究转产品，我很愿意交流。</p>
    </div>
    <div class="founder-actions">
